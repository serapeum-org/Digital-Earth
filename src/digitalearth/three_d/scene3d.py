...
class Scene3D(Scene3DBase, TerrainMixin, PointCloudMixin, VolumeMixin, VectorMixin, GlobeMixin):
    ...
    :meth:`isosurface`, :meth:`vectors`, :meth:`extruded_polygons`, :meth:`globe`). See those classes for the
    full surface.
