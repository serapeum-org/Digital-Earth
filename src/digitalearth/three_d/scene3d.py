...
Further mixins (vectors, textured globe) are added as the tier is built.
...
class Scene3D(Scene3DBase, TerrainMixin, PointCloudMixin, VolumeMixin):
    ...
    :meth:`isosurface`). See those classes for the full surface.
